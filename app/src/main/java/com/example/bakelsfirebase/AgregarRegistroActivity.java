...
public class AgregarRegistroActivity extends AppCompatActivity {
    ...
    private EditText nombreEt, marcaEt, categoriaEt, precioEt, stockEt;
    ...
    private String nombre, marca, categoria, precio, stock;
    ...
    private void inputData() {
        ...
        marca = "" + marcaEt.getText().toString().trim();
        categoria = "" + categoriaEt.getText().toString().trim();
        precio = "" + precioEt.getText().toString().trim();
